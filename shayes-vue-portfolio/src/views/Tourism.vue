   ...
   <div class="image-flex">
    ...
    <div class="persona">
        ...
        <div class="persona-flex">
            ...
            <div class="image-julie">
            <img src="../assets/images/tourism/julie.png">
            </div>

           <div class="text-julie">
            <h3>Name: Julie</h3>
            <h3>Age: 34</h3>
            <h3>Occupation</h3>
            <h3>Class: Middle</h3>
...
<div class="low-fi">
    <h1>Low-Fi Wireframes</h1>
    <div class="lowfi-flex">

        <div class="lowfi">
            <p>Landing</p>
            <img src="../assets/images/tourism/lowfi1.png">
        </div>

        <div class="lowfi">
            <p>Filtering</p>
            <img src="../assets/images/tourism/lowfi2.png">
        </div>
